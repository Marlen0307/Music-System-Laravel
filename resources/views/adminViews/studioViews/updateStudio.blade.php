...
@section('content')
    <div class="flex justify-center">
        <div class="w-8/12  sm:w-6/12 md:w-4/12 bg-white p-6 rounded shadow my-10">
            ...
            @endif
            <form method="post" action="{{route("updateStudio", $studio)}}" enctype="multipart/form-data">
                @method("PUT")
                @csrf
                <div class="mb-4" >
                    ...
                    w-full p-4 rounded @error('name') border-red-500 @enderror"
                            placeholder="Studio name" value="{{$studio->name}}">
                ...
                <div class="mb-4" >
                    ...
                    w-full p-4 rounded @error('location') border-red-500 @enderror"
                            placeholder="Location" value="{{$studio->location}}">
                ...
                <div class="mb-4" >
                    ...
                    w-full p-4 rounded @error('email') border-red-500 @enderror"
                           placeholder="Email" value="{{$studio->email}}">
                ...
                <div class="mb-4" >
                    ...
                    border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500
                    focus:border-transparent
                    w-full p-4 rounded @error('found_date') border-red-500 @enderror" value="{{$studio->foundation_date}}">
                    @error('found_date')
                    <div class="text-red-500 mt-2">
                        {{$message}}
                    </div>
                ...
                <div class="mb-4" >
                    ...
                    w-full p-4 rounded @error('mobile') border-red-500 @enderror"
                           placeholder="Mobile" value="{{$studio->mobile}}" >
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-wrap mt-2 @error('genres') border border-red-500 @enderror">
                        @foreach($genres as $genre)
                            <div class="mx-1">
                                <input type="checkbox" @if($selectedGenres->contains($genre->id)) checked @endif
