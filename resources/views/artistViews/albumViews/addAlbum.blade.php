            ...
            @endif
                <form method="post" action="{{route("addAlbum")}}" enctype="multipart/form-data">
                    ...
                    w-full p-4 rounded @error('title') border-red-500 @enderror"
                                placeholder="Album title" value="{{old('title')}}">
                    ...
                    border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500
                    focus:border-transparent
                    w-full p-4 rounded @error('release_date') border-red-500 @enderror" value="{{old('release_date')}}">
                        @error('found_date')
                        <div class="text-red-500 mt-2">
                            {{$message}}
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex border border-transparent flex-wrap mt-2 @error('studios') border-red-500 @enderror">
                            @foreach($studios as $studio)
                                <div class="mx-1">
                                    <input type="checkbox" name="studios[]" value="{{$studio->id}}">
